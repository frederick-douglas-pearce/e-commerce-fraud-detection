...
**Option A: Using Cloud Build (Recommended - builds in Google Cloud)**
...
**Option B: Using Local Docker (Alternative - requires Docker locally)**
...
# --port: Container port (must match Dockerfile EXPOSE)
```
